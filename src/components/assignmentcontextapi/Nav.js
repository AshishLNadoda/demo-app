...
export const Navbar = ()=>{
    ...
    return <Box>
        <Flex justifyContent={"space-around"}  p={"10px"} alignItems={"center"}>
            <Text fontSize={{sm:"1x3",md:"8xl"}} fontWeight={"700"} color={"lightsalmon"}  textShadow={"1px 1px 1px rgb(165, 37, 69)"} >Movie Mania</Text>
            <Box>
                <Flex>
